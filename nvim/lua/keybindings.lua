...
map("n", "<space>hm", ":lua require('harpoon.ui').toggle_quick_menu()<CR>")
map("n", "<space>ha", ":lua require('harpoon.mark').add_file()<CR>")
map("n", "<space>n", ":lua require('harpoon.ui').nav_next()<CR>")
map("n", "<space>N", ":lua require('harpoon.ui').nav_prev()<CR>")
map("n", "<space>h1", ":lua require('harpoon.ui').nav_file(1)<CR>")
map("n", "<space>h2", ":lua require('harpoon.ui').nav_file(2)<CR>")
map("n", "<space>h3", ":lua require('harpoon.ui').nav_file(3)<CR>")
map("n", "<space>h4", ":lua require('harpoon.ui').nav_file(4)<CR>")

map("n", "<space>t", ":Lspsaga term_toggle<CR>")
map("t", "<space>t", "<C-\\><C-n>:q<CR>")
